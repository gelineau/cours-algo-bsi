...
#     current_element = linked_list
#     while True:
#         if current_element.next == None:  # or is None
#             return current_element.value
#         current_element = current_element.next
...
def get_element_by_index(linked_list: LinkedList, index: int) -> int:
    current_element = linked_list
...
print(
    f"{get_element_by_index(my_list, 1)=} {get_element_by_index(my_list, 2)=} {get_element_by_index_rec(my_list, 2)=}"
)
